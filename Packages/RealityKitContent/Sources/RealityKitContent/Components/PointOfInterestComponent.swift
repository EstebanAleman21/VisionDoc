...
public enum Region: String, Codable, CaseIterable {
    ...
    public func opacity(forSliderValue sliderValue: Float) -> Float {
        switch self {
        case .mainModel: return 1.0 - sliderValue
        case .detailModel: return sliderValue
        }
    }
    ...
    public func gain(forSliderValue sliderValue: Float) -> Audio.Decibel {
        ...
        switch self {
        case .mainModel: return Audio.Decibel.lerp(a: fullyOn, b: fullyOff, t: Audio.Decibel(sliderValue))
        case .detailModel: return Audio.Decibel.lerp(a: fullyOff, b: fullyOn, t: Audio.Decibel(sliderValue))
        }
    }
}
...
public struct PointOfInterestComponent: Component, Codable {
    ...
    public var region: Region = .mainModel
